...
<head>
    ...
    <title>Recuperación de contraseña — TalentSphere</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 32px;">
                            ...
                            <p style="color:#374151; font-size:15px; line-height:1.7; margin: 0 0 28px;">
                                Hola <strong style="color:#1a1a2e;">{{ $nombre }}</strong>, recibimos una solicitud para restablecer la contraseña de tu cuenta en TalentSphere. Si fuiste tú, haz clic en el botón para definir una nueva contraseña.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:12px 16px;">
                                        <p style="margin:0; color:#92400e; font-size:13px; line-height:1.5;">
                                            Este enlace expira en <strong>30 minutos</strong>. Solo funciona una vez.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background:#f9f9fb; padding:18px 40px; border-top:1px solid #e5e7eb;">
                            <p style="color:#c0c8d8; font-size:11.5px; margin:0; text-align:center; font-family: 'Courier New', monospace; letter-spacing:0.3px;">
                                talentsphere.cloud — correo automático, no respondas
                            </p>
                        </td>
                    </tr>
